...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="wedding-banner">
        <div class="banner-content">
            ...
            <p>Celebrate love in a dreamy setting – where nature’s beauty, elegant venues, and perfect planning make every moment unforgettable.</p>
        </div>
    </section>
        ...
        <div class="services-container">
            <div class="services-left">
                ...
                <ul>
                    ...
                    <li>✅ Party Plot</li>
                    <ul><li>➡ Vraj Village (1,00,000 Sq.ft.)</li></ul>
    ...
    <section class="vraj-section">
        <div class="vraj-container">
            <div class="vraj-left">
                ...
                <p>The lush green expansive village-themed venue of <b>1,00,000 Sq. feet</b> can accommodate over <b>1500 guests</b>.</p>
                <p>Includes <b>water fountains</b>, <b>air-conditioned washrooms</b>, and complimentary themed rooms.</p>
            </div>
            <div class="vraj-right">
                <img src="../img/gallery29.jpg" />
            </div>
        </div>
    </section>
    ...
    <section class="halls-section">
        ...
        <div class="halls-grid">
            <div class="hall-card">
                <img src="../img/Royal Crystal Hall.jpg" />
                <div class="hall-info">
            ...
            <div class="hall-card">
                <img src="../img/Emerald Celebration Hall.jpg" />
                <div class="hall-info">
    ...
    <section class="cta-section">
        <div class="cta-content">
            ...
            <p>From elegant <b>weddings</b> to grand <b>corporate gatherings</b> – Hidden Valley offers premium venues, seamless planning, and unforgettable experiences.</p>
